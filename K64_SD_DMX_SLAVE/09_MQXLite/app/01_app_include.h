...
G_VAR_PREFIX uint_8 uart_recvBuf[2100];
G_VAR_PREFIX uint_8 isuartsaveover;
...
#define  EVENT_UARTSAVEISR      ((1uL)<<(8))   //事件位
...
#define TASK_UARTSAVE                 10
//4.为任务创建任务栈
#define TASK_MAIN_STACK_SIZE        (sizeof(TD_STRUCT) + 1024*53 + PSP_STACK_ALIGNMENT + 1)
...
#define TASK_UARTSAVE_STACK_SIZE     (sizeof(TD_STRUCT) + 1024*6 + PSP_STACK_ALIGNMENT + 1)
